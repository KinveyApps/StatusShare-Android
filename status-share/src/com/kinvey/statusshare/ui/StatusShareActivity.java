...
public class StatusShareActivity extends Activity {
    public static final String TAG = StatusShareActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSharedClient.isKinveyReachable(new KinveyCallback<Boolean>() {
            ...
            public void onSuccess(Boolean b) {
                ...
                StatusShareActivity.this.startActivity(new Intent(StatusShareActivity.this, LoginActivity.class));
