...
public class UpdateEditFragment extends KinveyFragment implements View.OnClickListener {
    ...
    public void doUpdate() {
        ...
        saveUpdateAttachment(progressDialog, byteArray,
                getClient().getActiveUser().getId() + "_attachment_" + System.currentTimeMillis() + ".png");
    }

    public void saveUpdateAttachment(final ProgressDialog progressDialog, byte[] bytes, String filename) {
        UpdateEntity updateEntity = new UpdateEntity(getClient().getActiveUser().getId());
        ...
        dataStore.save(updateEntity, new KinveyClientCallback<UpdateEntity>() {
            @Override
